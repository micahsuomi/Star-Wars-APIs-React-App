    ...
    render() {
        return(
           ...
           
            {
                ...
                <p className="about-me-description">I'm a self-thought front-end developer. I aim to create beautiful, responsive and user-friendly web pages, and I pay a lot of attention to UI and prototyping. I usually build everything from scratch rendering a page more unique and customized. I have a background in art and design (also self-taught). I love working with designs, colors and contrast, whitespaces, font-sizes. It just feels natural to me. I'm now focusing on React and modern JavaScript. When I'm not coding, I'm into UI Design, painting, digital illustrations and photography.You can view my web development porfolio at the link. Most of my work includes responsive design with HTML, CSS, JavaScript, Sass and Bootstrap. You can view my porfolio at<a href={porfolioLink}></a></p> : ''
            }
